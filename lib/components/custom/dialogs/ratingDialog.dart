...
class RatingDialog extends StatefulWidget {
  ...
  RatingDialogState createState() =>
      RatingDialogState(anime, onSend, newRating);
}
...
class RatingDialogState extends State<RatingDialog> {
      ...
      actions: <Widget>[
        FlatButton(
          ...
          onPressed: () {
            ...
            _rating =
                anime.ownVote == null ? 0 : anime.ownVote.value.floorToDouble();
          },
        ),
        FlatButton(
          color: Colors.green,
  ...
  sendData() async {
    var newAnimeData = await AnimeRequests.getAnime(anime.url);
    AnimeRequests.setShowVote(
        newAnimeData.id, newAnimeData.ownVote?.value, _rating.round());
  }
}
